...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕ JOIN CHANNEL ⭕', url='https://t.me/+Mv3AtoOsJZs2OWU1'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/moviehubofficial18')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ MovieReqGroup ✅', url='https://t.me/moviereqgroup_movieshub')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
